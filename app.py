...
#LABEL WIDGETS
Poul_label = Label(Forms, text="Poul [ A - H ]:", font=('Times new roman', 16), bd=15)
Poul_label.grid(row=0)

Nom_label = Label(Forms, text="Nom de l'Equipe :", font=('Times new roman', 16), bd=15)
Nom_label.grid(row=1)

NB_Match_label = Label(Forms, text="Nombre des Matches :", font=('Times new roman', 16), bd=15)
NB_Match_label.grid(row=2)

Total_Point_label = Label(Forms, text="Total Point :", font=('Times new roman', 16), bd=15)
Total_Point_label.grid(row=3)

NB_Victoir_label= Label(Forms, text="Nombre des Victoires :", font=('Times new roman', 16), bd=15)
NB_Victoir_label.grid(row=4)

NB_Defait_label = Label(Forms, text="Nombre des Defaites :", font=('Times new roman', 16), bd=15)
NB_Defait_label.grid(row=5)

NB_Match_Null_label= Label(Forms, text="Nombre des Match Null :", font=('Times new roman', 16), bd=15)
NB_Match_Null_label.grid(row=6)

But_Marque_label= Label(Forms, text="But Marques :", font=('Times new roman', 16), bd=15)
But_Marque_label.grid(row=7)

But_Concede_label= Label(Forms, text="But Concede :", font=('Times new roman', 16), bd=15)
...
#ENTRY WIDGETS
Poul_Name= Entry(Forms, textvariable="Poul", width=30,bg='#A8EDDA')
Poul_Name.grid(row=0, column=1,padx="0px 50px")

Nom= Entry(Forms, textvariable="Nom", width=30,bg='#A8EDDA')
Nom.grid(row=1, column=1,padx="0px 50px")

NB_Match = Entry(Forms, textvariable="NB_Match", width=30,bg='#A8EDDA')
NB_Match.grid(row=2, column=1,padx="0px 50px")

Total_Point = Entry(Forms, textvariable="Total_Point", width=30,bg='#A8EDDA')
Total_Point.grid(row=3, column=1,padx="0px 50px")

NB_Victoir= Entry(Forms, textvariable="NB_Victoir", width=30,bg='#A8EDDA')
NB_Victoir.grid(row=4, column=1,padx="0px 50px")


NB_Defait = Entry(Forms, textvariable="NB_Defait", width=30,bg='#A8EDDA')
NB_Defait.grid(row=5, column=1,padx="0px 50px")

NB_Match_Null= Entry(Forms, textvariable="NB_Match_Null", width=30,bg='#A8EDDA')
NB_Match_Null.grid(row=6, column=1,padx="0px 50px")

But_Marque= Entry(Forms, textvariable="But_Marque",  width=30,bg='#A8EDDA')
But_Marque.grid(row=7, column=1,padx="0px 50px")


But_Concede= Entry(Forms, textvariable="But_Concede",  width=30,bg='#A8EDDA')
But_Concede.grid(row=8, column=1,padx="0px 50px")


#BUTTONS WIDGET

Btn_create = Button(Buttons, width=10, text="Create", command=Create, bg='#A8EDDA')
Btn_create.pack(side=LEFT)


Btn_update = Button(Buttons, width=10, text="Update", command=Update, bg='#A8EDDA')
Btn_update.pack(side=LEFT)

Btn_sort = Button(Buttons, width=10, text="Sort", command=TreeSort, bg='#A8EDDA')
Btn_sort.pack(side=LEFT)

Btn_delete = Button(Buttons, width=10, text="Delete", command=Delete, bg='#A8EDDA')
Btn_delete.pack(side=LEFT)


Btn_clear = Button(Buttons, width=10, text="Clear", command=Clear, bg='#A8EDDA')
Btn_clear.pack(side=LEFT)


#LIST WIDGET
Scrollbary = Scrollbar(Right, orient=VERTICAL,bg='#97C180')
Scrollbarx = Scrollbar(Right, orient=HORIZONTAL,bg='#97C180' )
